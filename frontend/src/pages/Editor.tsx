  ...
  useEffect(() => {
    ...
    if (terminalRef.current && !term.current) {
      term.current = new Terminal({
        ...
        cursorBlink: true,
        scrollback: 1000, // Enables scrollback for the terminal
      });
    ...
    // Listen for code updates from other users in the same room
  ...
  return (
    <div className="flex flex-col items-center justify-start min-h-screen bg-gray-900 text-white py-4">
      ...
      <div className="flex flex-col w-[90vw] mt-4 bg-gray-800 rounded-lg shadow-lg">
        ...
        <div
          ref={terminalRef}
          className="h-[40vh] bg-black p-4 rounded-b-lg overflow-x-auto"
